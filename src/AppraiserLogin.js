        ...
        <form className="admin-login-panel" onSubmit={this.login}>
          {
            ...
            <div>
              ...
              <RaisedButton type="submit" type="submit" label="Sign In" name="adminLogin" id="adminLogin" fullWidth={true} secondary={true} autoComplete={false}/>
              <RaisedButton type="submit" label="Sign Up" primary={true} fullWidth={true}  onTouchTap={()=>(this.props.statusHandle('signup'))}/>
            </div>
          }
        </form>
      }
